...
const clientFields: Field[] = [
  ...
  { name: 'name', label: '乙方', component: 'a-input', props: { placeholder: '请输入乙方-名称' } },
  { name: 'business', label: '业务', component: 'a-input', props: { placeholder: '请输入 业务' } },
  { name: 'usage', label: '用途', component: 'a-input', props: { placeholder: '请输入 用途' } },
...
const handleSubmit = async (form: CClientVO) => {
  ...
  await store.createClientByPartyId(props.partyId, form);

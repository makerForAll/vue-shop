<template>
    ...
    <a-table :scroll="{ x: 1200, y: 500 }" :columns="clientColumns" :row-key="(record: any) => record.id"
        :data-source="partyStore?.data?.RItems" :pagination="pagination" :loading="loading" @change="handleTableChange">
...
const queryData = async (params: any, filters: any): Promise<void> => {
    ...
    if (params) {
        ...
        await partyStore.read(params, filters);
    }

<template>
    <CreateAndUpdateView :action="'编辑'" :entity-type="'支付相关'" @show-drawer="showDrawer" @handle-submit="handleSubmit"
        @field-change="fieldChange" @close-drawer="closeDrawer">
    </CreateAndUpdateView>
</template>

<script setup lang="ts">
import CreateAndUpdateView from '@/2-biz-complex/cp-projectCP/PaymentPlansplit/ReadPaymentPlansplit/CreateAndUpdate.vue';

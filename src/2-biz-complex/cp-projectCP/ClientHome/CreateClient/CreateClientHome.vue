...
const clientFields: Field[] = [
  ...
  },
  {
    ...
    label: '乙方名称',
    component: 'a-input',
    props: { placeholder: '请输入乙方-名称' }
  },
  {
    name: 'IDcard',
    label: '乙方身份证号码',
    component: 'a-input',
    props: { placeholder: '请输入乙方-身份证号码' }
  },
  ...
  { name: 'usage', label: '需求', component: 'a-input', props: { placeholder: '请输入 需求' } },
  {
    ...
    label: '联系人',
    component: 'a-input',
    props: { placeholder: '请输入联系人-名称' }
  },
  {
    name: 'phonenumber',
    label: '联系人号码',
    component: 'a-input',
    props: { placeholder: '请输入联系人-号码' }
  },
  {
    name: 'emergencycontact',
    label: '紧急联系人',
    component: 'a-input',
    props: { placeholder: '请输入紧急联系人-名称' }
  },
  {
    name: 'emergencycontactphone',
    label: '紧急联系人号码',
    component: 'a-input',
    props: { placeholder: '请输入紧急联系人-号码' }
  },
